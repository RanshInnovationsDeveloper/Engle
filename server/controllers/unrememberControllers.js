...
const removeFromUnremember=async(req,res)=>{
 ...
 try {
    ...
    const docRef = doc(db, "unremember", userId); //Takng the reference to the document in firebase with remember s collection name and userId as document name 
...
const fetchAllUnrememberItems = async (req, res) => {
    try {
        //Can take a particular reqType from quey to reduce read data at unremember
      ...
      //Taking the reference to the document in firebase with unremember as collection name and userId as document name
        const docRef = doc(db, "unremember", userId); //Taknig the reference to the document in firebase with unremember as collection name and userId as document name
        const docSnap = await getDoc(docRef); //Fetching the document from the db
        ...
        //Types of data that can be stored in unremember
