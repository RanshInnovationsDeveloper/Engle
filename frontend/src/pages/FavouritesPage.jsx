...
const { GET_FAVOURITE_STATUS_API, GET_FAVOURITE_API } = favouriteEndpoints;
...
function FavouritesPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await apiConnector("GET", GET_FAVOURITE_API, {
          userId: authUserId, // use authUserId from your Redux state
        });
        setData(response);
      } catch (error) {
        console.log(error);
