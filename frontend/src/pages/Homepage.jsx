...
function Homepage() {
  ...
  return (
    ...
    <div className="container mt-12">
      ...
      <div className="text-black lg:p-10 p-5 lg:mx-4 flex flex-col">
        ...
        <div className="flex-grow flex flex-col lg:mt-[6rem] mt-3">
          ...
          <img className="lg:w-[30%] lg:h-[30%] w-[90%] h-[90%]  " src="home_3_img.png" alt="home_3_image" />
            <p className="lg:w-[45%] lg:h-[45%] w[100%] h-[100%] text-lg leading-8 tracking-wide"> Explore the engaging world of learning with Engle's innovative flashcards feature. Immerse yourself in a dynamic experience as random words are presented for your consideration. This interactive tool not only challenges your vocabulary but also allows you to assess your knowledge instantly. Whether you're familiar with the words or encountering them for the first time, Engle's flashcards provide a fun and effective way to reinforce your English language skills. Elevate your learning journey with this dynamic and personalized approach to mastering new words effortlessly.</p>
        ...
        <div className="flex-grow flex flex-col lg:mt-[6rem] mt-3">
          ...
          <div className="flex-grow flex lg:flex-row flex-col justify-center items-center gap-[6rem]">
            <p className="lg:w-[45%] lg:h-[45%] w[100%] h-[100%]  text-lg leading-8 tracking-wide"> Discover the immersive world of learning with Engle through our captivating 'Learn with Stories' feature. Dive into your favorite narratives while effortlessly enhancing your English skills. With the ability to bookmark challenging or preferred words, you can further enrich your vocabulary. Explore the depths of storytelling and seamlessly integrate language learning into your reading experience. Whether you're unraveling gripping tales or exploring imaginative adventures, Engle makes language acquisition an engaging and enjoyable journey.</p>
        ...
        <div className="flex-grow flex flex-col lg:mt-[6rem] mt-3">
          ...
          <img className="lg:w-[35%] lg:h-[35%] w-[90%] h-[90%]  " src="home_5_img.png" alt="home_5_image" />
            <p className="lg:w-[45%] lg:h-[45%] w[100%] h-[100%]  text-lg leading-8 tracking-wide"> Experience the joy of collaborative learning with Engle's 'Learn with Friends' feature. Connect with peers and turn your English learning journey into a social and enjoyable experience. Engage in interactive sessions, share insights, and reinforce your language skills while having fun with friends. With Engle, language learning becomes a shared adventure, fostering a supportive community of learners.</p>
